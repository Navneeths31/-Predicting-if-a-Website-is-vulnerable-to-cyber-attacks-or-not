We try to predict whether a given website which was created using JavaScript is vulnerable or not, using Machine Learning algorithms. The data was collected from Kaggle.
